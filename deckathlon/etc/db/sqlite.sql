...
INSERT OR IGNORE INTO templates (fk_creator, name, opts, dt_created, dt_changed) VALUES (1, 'Tuhat', '{"sort": ["suite", "strength"], "suites": "HSDC", "redeal": {"condition": {"hand": ["9H", "9S", "9D", "9C"], "min": 3}}, "trump": true, "lead": {"0": "bidder", "*": "trick"}, "talon": {"face": false}, "move": {"win": {"suite": true, "level": true}, "pass": false, "cards": 1, "crawl": 0, "response": {"suite": true}, "special": {"wheels": {"0": false, "*": [["AD", "0D"], ["AH", "0H"], ["AS", "0S"], ["AC", "0C"]], "condition": {"opt": "trump", "suite": true}}, "trump": {"0": false, "*": [["KD", "QD"], ["KH", "QH"], ["KS", "QS"], ["KC", "QC"]], "condition": {"cards": 3}}}}, "reveal": true, "hand": 7, "trick": true, "players": [3, 4], "points": {"bidonly": {"min": 900}, "trump": {"C": 100, "H": 60, "S": 80, "D": 40}, "penalties": {"blind": {"value": -2, "op": "mul"}, "nochange": {"op": "add", "value": -100, "times": 3}, "bid": {"value": -1, "op": "mul"}}, "trick": {"A": 11, "K": 4, "J": 2, "Q": 3, "0": 10, "9": 0}, "bonuses": {"blind": {"value": 2, "op": "mul"}}, "wheels": 120}, "bidding": {"sell": true, "blind": true, "min": 60, "max": {"blind": 120, "*": 120, "trump": 340}, "distribute": true, "pass_final": true, "talon": true, "step": 5, "pass": true}, "pass": false, "cards": ["9S", "9H", "9D", "9C", "JS", "JH", "JD", "JC", "QS", "QH", "QD", "QC", "KS", "KH", "KD", "KC", "0S", "0H", "0D", "0C", "AS", "AH", "AD", "AC"], "strengths": "9JQK0A", "order": true, "complete": {"score": 1000}}', '2020-04-18 22:07:23.000000+00:00', '2020-05-03 18:01:29.635000+00:00');
